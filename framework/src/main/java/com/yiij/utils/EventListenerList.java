/* http://firefly-client-android.googlecode.com/svn/trunk/src-compat/javax/swing/event/EventListenerList.java */
/*
...
public class EventListenerList<X extends java.util.EventListener> implements Serializable {

    protected transient Object[] listenerList = new Object[0];

    public synchronized <T extends X> void remove(
    ...
    public synchronized <T extends X> void add(
            final Class<?> listenerClass,
            final T listener
    ) {
        if (listener == null) {
	...
	public <T extends X> T[] getListeners(final Class<?> listenerClass) {
