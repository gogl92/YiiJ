...
public class Start {
    public static void main(String[] args) throws Exception {
        int timeout = (int) 1000 * 60 * 60; //Duration.ONE_HOUR.getMilliseconds();
        
        PropertyConfigurator.configure("src/main/webapp/WEB-INF/classes/log4j.properties");
        ...
        if (keystore != null && keystore.exists()) {
            ...
            factory.setKeyStorePassword("yiij");
            factory.setTrustStore(keystore);
            factory.setKeyManagerPassword("yiij");
